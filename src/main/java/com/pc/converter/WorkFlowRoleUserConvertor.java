...
@Service
public class WorkFlowRoleUserConvertor implements Converter {
    ...
    public Object getAsObject(FacesContext fc, UIComponent uc, String value) {
        ...
        if (StringUtils.isBlank(value)) {
            ...
            try {
                ...
                return workFlowRoleUserService.findById(Long.parseLong(value));
    ...
    public String getAsString(FacesContext fc, UIComponent uc, Object obj) {
        if (obj != null) {
            return "" + ((WorkFlowRoleUser) obj).getId();
        } else {
            return "";
        }
    }
