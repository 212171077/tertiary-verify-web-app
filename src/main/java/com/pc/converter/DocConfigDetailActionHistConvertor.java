...
@Service
public class DocConfigDetailActionHistConvertor implements Converter {
    ...
    public Object getAsObject(FacesContext fc, UIComponent uc, String value) {
        ...
        if (StringUtils.isBlank(value)) {
            ...
            try {
                ...
                return docConfigDetailActionHistService.findById(Long.parseLong(value));
    ...
    public String getAsString(FacesContext fc, UIComponent uc, Object obj) {
        if (obj != null) {
            return "" + ((DocConfigDetailActionHist) obj).getId();
        } else {
            return "";
        }
    }
